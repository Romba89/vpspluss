...
ExecStart=/usr/local/bin/ohpserver -port 8181 -proxy 127.0.0.1:25800 -tunnel 127.0.0.1:1194
Restart=on-failure
...
AmbientCapabilities=CAP_NET_ADMIN CAP_NET_BIND_SERVICE
NoNewPrivileges=true
ExecStart=/usr/local/bin/ohpserver -port 8080 -proxy 127.0.0.1:25800 -tunnel 127.0.0.1:1194
Restart=on-failure
LimitNOFILE=infinity
...
AmbientCapabilities=CAP_NET_ADMIN CAP_NET_BIND_SERVICE
NoNewPrivileges=true
ExecStart=/usr/local/bin/ohpserver -port 8383 -proxy 127.0.0.1:25900 -tunnel 127.0.0.1:1194
Restart=on-failure
LimitNOFILE=infinity

...
ExecStart=/usr/local/bin/ohpserver -port 8181 -proxy 127.0.0.1:8080 -tunnel 127.0.0.1:22
Restart=on-failure
...
AmbientCapabilities=CAP_NET_ADMIN CAP_NET_BIND_SERVICE
NoNewPrivileges=true
ExecStart=/usr/local/bin/ohpserver -port 8181 -proxy 127.0.0.1:3128 -tunnel 127.0.0.1:109
Restart=on-failure
LimitNOFILE=infinity
...
AmbientCapabilities=CAP_NET_ADMIN CAP_NET_BIND_SERVICE
NoNewPrivileges=true
ExecStart=/usr/local/bin/ohpserver -port 8383 -proxy 127.0.0.1:8799 -tunnel 127.0.0.1:1194
Restart=on-failure
LimitNOFILE=infinity
